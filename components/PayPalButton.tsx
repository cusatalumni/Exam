...
const PayPalButton: React.FC<PayPalButtonProps> = ({ price, examId, onSuccess }) => {
  ...
  const handleSimulatePayment = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      toast.dismiss();
      toast.success('Payment successful! This exam is now unlocked.');
      onSuccess(examId);
    }, 2000);
  };
  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
        <p className="font-bold text-blue-800 text-lg mb-2">One-Time Payment: ${price.toFixed(2)}</p>
